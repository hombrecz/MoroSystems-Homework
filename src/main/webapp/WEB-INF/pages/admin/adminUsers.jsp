	...
	<c:if test="${not empty userslist}">
		...
		<c:forEach items="${userslist}" var="user">
		    <tr>	
				...
				<td>${user.username}</td>
				<td>
					<form:form method="get" modelAttribute="user" action="adminUserAddEdit">
				...
				<td>
					<form:form method="post" modelAttribute="user" action="adminUserDelete">
						<form:input type="hidden" path="userid" value="${user.userid}"/>
						<form:input type="hidden" path="username" value="${user.username}"/>
						<form:input type="hidden" path="enabled" value="${user.enabled}"/>
				...
				<td>
					<form:form method="get" modelAttribute="user" action="adminUserDetail">
						<form:input type="hidden" path="userid" value="${user.userid}"/>
						<form:input type="hidden" path="username" value="${user.username}"/>
						<form:input type="hidden" path="enabled" value="${user.enabled}"/>
			...
			<tr>
				...
				<td>			
					...
					<form:input type="hidden" path="username" value="new name"/>
					<form:input type="hidden" path="password" value="new password"/>
